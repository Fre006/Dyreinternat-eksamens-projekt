...
namespace Lib.Model
{
    ...
    public class Animal
    {
        ...
        {
            return $"Name: {Name}, Characteristics: {Characteristics}, Status: {Status}, IsMale: {Male}, Fertile: {Fertile}, Size: {Size}, ChipID: {ChipID}, Description: {Description}, Birthdate:{Birthdate}, Event amount{Logs.Count}";
        }
